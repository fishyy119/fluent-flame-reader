...
const isVideo = (url: string) =>
{
    ...
    return extensionSearch && extensionSearch.length > 1 && videoExtensions.includes(extensionSearch[1]);
}
...
const mediaElement = (props: CardThumbnailProps) =>
{
    ...
    if(props.allowVideo)
    {
        ...
        const video = <video className={props.className} src={props.item.thumb} muted autoPlay ref={ref} loop></video>
