# NOTE: this won't work anymore given the hard-fork of the original Fluent Reader.
# This will need to be remade (or removed).

# Name of your app.
APP="Fluentflame Reader"
# Your Certificate name.
CERT="Jieyu Yan (EM8VE646TZ)"
# The path of your app to sign.
APP_PATH="bin/darwin/universal/mas-universal/Fluentflame Reader.app"
...
sed -i '' -e 's/<\/dict>/<key>ElectronTeamID<\/key><string>EM8VE646TZ<\/string><\/dict>/g' "bin/darwin/universal/mas-universal/Fluentflame Reader.app/Contents/Info.plist"
